...
public class Context {
	...
	private static class AutoGeneratedTypeInfo {
		...
		public AutoGeneratedTypeInfo(AutoGeneratedType autoGeneratedType, List<SymbolType> componentTypes, Set<ListOption> listOptions) {
	...
	public SymbolType optional(SymbolType symbolType) {
		...
		if (!this.autoGeneratedTypes.containsKey(optionType)) {
			this.autoGeneratedTypes.put(optionType, new AutoGeneratedTypeInfo(AutoGeneratedType.Option, Collections.singletonList(symbolType), null));
		}
	...
	public SymbolType listOf(SymbolType elementType, SymbolType separatorType, ListOption... listOptions) {
		...
		if (!this.autoGeneratedTypes.containsKey(listType)) {
			this.autoGeneratedTypes.put(listType, new AutoGeneratedTypeInfo(AutoGeneratedType.List, Arrays.asList(new SymbolType[] { elementType, separatorType }), distinctListOptions));
		}
	...
	public SymbolType oneOf(SymbolType... symbolTypes) {
		...
		if (!this.autoGeneratedTypes.containsKey(oneOfType)) {
			this.autoGeneratedTypes.put(oneOfType, new AutoGeneratedTypeInfo(AutoGeneratedType.OneOf, new ArrayList<SymbolType>(copy), null));
		}
	...
	public SymbolType tuple(SymbolType... symbolTypes) {
		...
		if (!this.autoGeneratedTypes.containsKey(tupleType)) {
			this.autoGeneratedTypes.put(tupleType, new AutoGeneratedTypeInfo(AutoGeneratedType.Tuple, new ArrayList<SymbolType>(Arrays.asList(symbolTypes)), null));
		}
