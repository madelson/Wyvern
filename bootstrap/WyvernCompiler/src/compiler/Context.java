...
public class Context {
	...
	private static class AutoGeneratedTypeInfo {
		...
		public final Collection<ListOption> listOptions;
	...
	public SymbolType listOf(SymbolType symbolType) {
		...
		if (!this.autoGeneratedTypes.containsKey(listType)) {
			this.autoGeneratedTypes.put(listType, new AutoGeneratedTypeInfo(AutoGeneratedType.List, Collections.singletonList(symbolType), null));
		}
