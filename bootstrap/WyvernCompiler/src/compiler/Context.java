...
public class Context {
	...
	public SymbolType getListElementType(SymbolType symbolType) {
		AutoGeneratedKey key = new AutoGeneratedKey(symbolType, AutoGeneratedType.List);
		List<SymbolType> innerTypes = this.autoGeneratedTypes.get(key);
		return innerTypes != null ? innerTypes.get(0) : null;
	}
	...
	public SymbolType listOf(SymbolType symbolType) {
		SymbolType listType = this.getNonTerminalSymbolType(String.format("List<%s>",
				symbolType.name()));
		AutoGeneratedKey key = new AutoGeneratedKey(listType, AutoGeneratedType.List);
		if (!this.autoGeneratedTypes.containsKey(key)) {
			this.autoGeneratedTypes.put(key, Collections.singletonList(symbolType));
		}
	...
	public SymbolType oneOf(SymbolType... symbolTypes) {
		...
		AutoGeneratedKey key = new AutoGeneratedKey(oneOfType, AutoGeneratedType.OneOf);
		if (!this.autoGeneratedTypes.containsKey(key)) {
			this.autoGeneratedTypes.put(key, Collections.unmodifiableList(Utils.toList(copy)));
		}
	...
	public Set<SymbolType> getOneOfInnerTypes(SymbolType symbolType) {
		List<SymbolType> innerTypes = this.autoGeneratedTypes.get(new AutoGeneratedKey(symbolType, AutoGeneratedType.OneOf));
